    ...
    try:
        ...
        for line in podcast_dialogue.splitlines():
            if line.startswith("**Host:**") or line.startswith("Host:") or line.startswith("**Host: ${host_name}**"):
                structured_dialogue.final_dialogue["dialogue"].append({"role": "Host", "content": line[6:].strip()})
                ...
                structured_dialogue.final_dialogue["dialogue"].append({"role": "Guest", "content": line[7:].strip()})
